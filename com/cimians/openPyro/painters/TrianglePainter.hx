package com.cimians.openPyro.painters;
	...
	class TrianglePainter implements IPainter {
		...
		public function new(?direction:String = Direction.UP){
		...
		public function setFill(color:UInt, ?alpha:Int=1, ?stroke:Stroke=null):Void{
			_fillColor = color;
			_fillAlpha = alpha;
			_stroke = stroke;	
		}
		
		public function setStroke(thickness:Float, ?color:UInt=0x000000, ?alpha:Int=1, ?pixelHinting:Bool=true):Void{
